 ...
 * This class runs the algorithm for  the actual DCRep Model Run and Conventional model.
 */

import java.util.*;


public class DCRepModel {
    ...
    private int[] fileSizeList = new int[] {50,200,350,500,650,800,950,1100,1350,1500}; // size in KB's
    ...
    public static void setAvg_response_time(int avg_response_time) {
        DCRepModel.avg_response_time = avg_response_time;
    }
 ...
 */
 public void createClusters(){
    ...
    public static void main(String args[]){
        ...
        DCRepModel model = new DCRepModel();
